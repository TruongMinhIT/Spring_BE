...
public class AuthClientController extends ABasicController {
    ...
    public ApiMessageDto<OAuth2AccessToken> loginInternal(@RequestHeader("Authorization") String authHeader,
        ...
        OAuth2AccessToken tokenResponse = authClient.getAccessToken(authHeader, request);
